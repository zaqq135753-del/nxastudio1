...
const CFG: Record<string, AppConfig> = {
  ...
  cosmosia: {
    slug: "cosmosia",
    name: "NXA Cosmos", shortName: "Cosmos", category: "Autoconhecimento",
    icon: Moon, accent: "indigo",
    pain: "Quero autoconhecimento, orientação emocional e um ritual diário personalizado.",
    heroTitle: "Receba uma leitura personalizada para o seu momento.",
    heroSubtitle: "Mapa astral, tarot e ritual do dia.",
    heroCta: { label: "Ver leitura de hoje", to: "/apps/cosmosia/tarot" },
    helpMePrompt: "Me ajuda a entender esse momento",
    missions: [
      { id: "chart", label: "Mapa astral", desc: "Leitura completa", icon: Stars, to: "/apps/cosmosia/mapa", prime: true },
      { id: "tarot", label: "Tarot", desc: "Tiragem guiada", icon: Sparkle, to: "/apps/cosmosia/tarot" },
      { id: "match", label: "Compatibilidade", desc: "Sinastria entre mapas", icon: Heart, to: "/apps/cosmosia/compatibilidade", prime: true },
    ],
    bottomNav: [
      { to: "/apps/cosmosia", label: "Início", icon: Home },
      { to: "/apps/cosmosia/tarot", label: "Leitura", icon: Sparkle },
    ...
    emptyStates: {
      stats: "Preencha seu perfil pra receber leituras mais precisas.",
      memory: "Vou lembrar seus temas de journaling e ciclos.",
      media: "Leitura em áudio disponível com Prime.",
    },
    smartNotification: "Lua nova hoje — quer sua leitura do ciclo?",
    autopilot: { name: "Leitura diária", desc: "Envio sua leitura personalizada todo dia." },
    cardHook: "Transforme autoconhecimento em ritual diário.",
    suggestions: [
      "Leitura pra minha semana",
      "Compatibilidade com meu par",
      "Ritual pra lua nova",
      "Tarot de decisão",
    ],
  },
