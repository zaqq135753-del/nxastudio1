...
const CFG: Record<string, AppConfig> = {
  ...
  cosmosia: {
    ...
    heroCta: { label: "Corrigir redação agora", to: "/apps/cosmosia/redacao" },
    helpMePrompt: "Me ajuda a estudar pro ENEM hoje",
    missions: [
      { id: "essay", label: "Corretor de Redação", desc: "Nota 0 a 1000 + 5 competências", icon: PenLine, to: "/apps/cosmosia/redacao" },
