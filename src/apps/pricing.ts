...
export const PRICING: Record<string, AppPricing> = {
  ...
  cosmosia: P({
    base: {
      ...
      priceLabel: "R$ 19 / mês",
      monthly: 19,
      tagline: "Astrologia e tarot no dia a dia.",
      features: [
        "Mapa astral básico",
        "Tarot simples",
        "Leituras gerais",
        "Perfil e dados de nascimento",
      ],
    },
    prime: {
      name: "NXA Cosmos Prime",
      priceLabel: "+ R$ 20 / mês",
      monthly: 20,
      tagline: "Leituras profundas: mapa completo, tarot ilimitado e sinastria.",
      features: [
        "Mapa astral completo",
        "Tarot ilimitado · tiragens avançadas",
        "Sinastria e compatibilidade",
        "Leituras diárias personalizadas",
        "Diário espiritual · fases da lua",
        "Áudios personalizados · relatório PDF",
      ],
    },
    primeCopy: "Adicione Cosmos Prime e desbloqueie mapa completo, tarot ilimitado, sinastria e leituras diárias personalizadas.",
    compare: [
      { feature: "Mapa astral", base: "básico", prime: "completo" },
      { feature: "Tarot", base: "simples", prime: "ilimitado" },
      { feature: "Sinastria", base: false, prime: true },
      { feature: "Áudios personalizados", base: false, prime: true },
    ],
  }),
